const About = () => {
    return (
        <div>
                ...
                <div class="container my-5">
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            ...
                            <p class="lead">We offer services in passenger transport sector in Poland</p>
                            <p class="my-1">
            ...
            <div class="py-5 bg-image-full" style={{ backgroundImage: `url('img/sekcja1.jpg'` }}>
                ...
                <div class="container my-5">
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            ...
                            <p class="lead">Our services give satisfaction to our customers for over three decades</p>
                            <p class="my-1">
            ...
            <div class="py-5 bg-image-full" style={{ backgroundImage: `url('img/sekcja2.jpg'` }}>
                <div style={{ height: 20 + 'rem' }}></div>
            </div>
            <section class="py-5">
                <div class="container my-5">
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            ...
                            <p class="lead">Experienced drivers is the basis</p>
                            <p class="my-1">
            ...
            <div class="py-5 bg-image-full" style={{ backgroundImage: `url('img/sekcja3.jpg'` }}>
                <div style={{ height: 20 + 'rem' }}></div>
            </div>
            <section class="py-5">
                <div class="container my-5">
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                            <h2>Offer</h2>
                            <p class="lead">Vehicle fleet well suited to your needs</p>
                            <p class="my-1">
